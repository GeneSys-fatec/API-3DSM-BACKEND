...
import com.servico_anexo.servico_anexo.exceptions.AnexoTamanhoExcedente;
import com.servico_anexo.servico_anexo.model.AnexoTarefaModel;
...
public class CriaAnexoService {
    ...
    public AnexoTarefaModel adicionarAnexo(MultipartFile arquivo) throws IOException {
        if (arquivo.isEmpty()) {
